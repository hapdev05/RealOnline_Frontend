...
import Table from "../components/Profile/List";
import SearchBar from "../components/Profile/SearchBar";
import Header from "../components/Profile/Header";
import Menu from "../components/Profile/Menu";
import PropertyGrid from "../components/Profile/PropertyGrid_BDS";
import ProjectGridTDC from "../components/Profile/PropertyGrid_TDS";
import InfoAccount from "../components/Profile/InformAccount";
import ChangePassword from "../components/Profile/ChangePassword";
import NewList from "../components/Profile/NewList";
...
const Profile = () => {
  ...
  const categories = ["Tất cả", "Giữ chỗ", "Đã cọc", "Đã mua", "Chuyển nhượng", "Đã xem", "Yêu thích", "Bất động sản", "Thông tin tài khoản", "Thay đổi mật khẩu", "Danh sách yêu cầu"];
      ...
      <div className="flex-1 p-4 w-3/4 overflow-y-auto">
        ...
        {selectedCategory !== "" && (
          <>
            ...
            {selectedCategory === "Danh sách yêu cầu" && <NewList />}
            {selectedItem && (
